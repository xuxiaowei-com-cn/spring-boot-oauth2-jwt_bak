/*
 ...
 Source Schema         : xuxiaowei-cloud

 Target Server Type    : MySQL
 Target Server Version : 50732
 File Encoding         : 65001

 Date: 02/12/2021 16:09:21
*/
...
CREATE TABLE `oauth_client_details`  (
  ...
  `access_token_validity` int(11) NULL DEFAULT NULL COMMENT 'token 有效时间，单位：秒。默认值：43200秒（12小时，参见：org.springframework.security.oauth2.provider.token.DefaultTokenServices#accessTokenValiditySeconds）',
  `refresh_token_validity` int(11) NULL DEFAULT NULL COMMENT '刷新 token 有效时间，单位：秒。默认值：2592000（30天，参见：org.springframework.security.oauth2.provider.token.DefaultTokenServices#refreshTokenValiditySeconds）',
